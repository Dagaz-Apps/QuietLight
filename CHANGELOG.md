...
- **Premium screen** — Subscribe first, then swipe through benefits
...
- **Updated About screen** — invitation-focused copy; Quiet Sun & Quiet Moon names
- **Settings & stability** — expanded options, smoother navigation, performance polish

Part of **1.1 — Reflection rhythm** ↓
...
- **Calm meter** — reflections for the day at a glance
- **A kinder daily rhythm** — rest is part of the practice

Updates since: 1.1.1

---

## 1.0 · Release · January 2026

Initial App Store release — three presences, gentle companionship, free & premium tiers.
